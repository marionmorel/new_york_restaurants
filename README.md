...
![Table schema](https://content.codecademy.com/courses/sql-intensive/nomnom.png)
...
8. Let’s order delivery to the house! Find all the close by spots in aMidtown, Downtown or Chinatown. (OR can be used more than once)
